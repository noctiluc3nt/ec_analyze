...
- **Obukhov length** $L$ (`calc_L`): The Obukhov length is a length scale that describes the effect of buoyancy versus shear (friction velocity)
$$ L = -\frac{u_*^3 \overline{T_v}}{\kappa \,g\,\overline{w'T'}}, $$
and is central in Monin-Obukhov similarity theory (MOST) for deriving dimensionless scaling parameters, on particular the stability parameter $\zeta$.
...
![](figures/fig_0301.png){width=600}
...
![](figures/fig_0302.png){width=350}
...
![](figures/fig_0303.png){width=350}
