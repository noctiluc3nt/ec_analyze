date=c("2022-04-04","2022-04-05","2022-04-06")
dir="/scratch/lauram/finse_excursion/flux_tower/data/"
dir_out=paste0(dir,"2022_spring/")

dir_in=paste0("/scratch/lauram/finse/cr6/",year)
...
for (j in 1:length(date)) {
	files=list.files(dir_in,pattern=date[j],full.name=T)
