...
- **Unit conversion (fluxes)** (`cov2sh`, `cov2lh`): Converts covariances to the respective flux in W/m$^2$, i.e., cov(w,T) to sensible heat flux and cov(w,q) to latent heat flux.
